...
- [ ] Add a CSV preflight validation step for weekly data updates.
- [ ] Simplify and centralize currency-rate/conversion logic.
- [ ] Cache data loading and repeated calculations within one `main.py` run.
