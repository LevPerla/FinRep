...
REPORT_TEXT_EN = {
    "Аналитика доходов": "Income analytics",
    "Доход по источникам за месяц": "Monthly income by source",
    "Доход и сбережения за месяц": "Monthly income and savings",
    "Аллокация доходов и сбережений по месяцам": "Monthly income and savings allocation",
    "Доли рассчитаны из всех поступлений внутри каждого месяца.": "Shares are calculated from all receipts within each month.",
    "Отрицательные доли отражают корректировки поступлений.": "Negative shares reflect receipt adjustments.",
    "Источник": "Source",
    "Зарплата": "Salary",
    "Проценты по депозиту": "Deposit interest",
    "Источник не определён": "Unknown source",
    "Всего поступлений": "Total receipts",
    "Нет поступлений": "No receipts",
    "Не удалось загрузить аналитику доходов.": "Unable to load income analytics.",
    "Пропуски не считаются нулевыми поступлениями.": "Missing months are not treated as zero receipts.",
    "Источник определяется по комментарию; нераспознанный доход остаётся в отдельной группе.": "Sources are inferred from comments; unrecognized income remains in a separate group.",
